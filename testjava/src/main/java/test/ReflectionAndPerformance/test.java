...
//	public static <T> T copy(Class<T> classType, Map<String, Object> map){
//        Field[] fields = classType.getDeclaredFields();
//        T object = null;
//        try {
//            object = classType.newInstance();
...
//                Field field = fields[i];
//                String fieldName = field.getName();
//                String value = ParameterValueGetter.getParameterValue(map, fieldName);
...
//            }
//        }catch (Exception e) {
//            LOG.error("error,failed to convert parameters to bean");
//            throw new WebException(ExceptionConstants.PARAMETERS_ERROR);
//        } 
//        return object;
//    }
}
