...
public class PoolingDataSourceExample {
    ...
    public static void main(String[] args) {
        ...
        DataSource dataSource = setupDataSource("jdbc:mysql://localhost:3306/mytest");
        System.out.println("Done.");
        ...
        try {
            ...
            rset = stmt.executeQuery("select id from user");
    ...
    public static DataSource setupDataSource(String connectURI) {
        ...
        // arguments.
        //
        ConnectionFactory connectionFactory = new DriverManagerConnectionFactory(connectURI,"root","abc123");
        ...
        //
        //comment by cs: 下面这个语句，把 connectionPool 传递到PoolableConnectionFactory的构造函数里，并把这个工厂设置到 connectionPool 的factory对象上，所以这句话是必须的
